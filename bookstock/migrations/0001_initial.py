# Generated by Django 3.2.9 on 2021-11-29 21:30
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('category', models.CharField(blank=True, choices=[('Sci-Fi', 'Sci-Fi'), ('Fantasy', 'Fantasy'), ('History', 'History'), ('Comics', 'Comics'), ('Poetry', 'Poetry'), ('Science', 'Science'), ('Action', 'Action'), ('Adventure', 'Adventure'), ('Nature', 'Nature')], max_length=50, null=True)),
                ('item_name', models.CharField(blank=True, max_length=50, null=True)),
